...
<div class="container text-center">
    ...
    <div class="btn-group btn-group-justified ja-navgroup" role="group" aria-label="Main Navigation Menu" id="navbar">
        ...
        if ((isset($_SESSION['username'])) && (isset($_SESSION['password'])))
        {
            ...
            <a href="main" type="button" class="btn ja-navbutton admin" role="button">MAIN</a>
            <a href="settings" type="button" class="btn ja-navbutton admin" role="button">SETTINGS</a>
            <a href="members" type="button" class="btn ja-navbutton admin" role="button">MEMBERS</a>
            <a href="mail" type="button" class="btn ja-navbutton admin" role="button">MAIL</a>
            <a href="money" type="button" class="btn ja-navbutton admin" role="button">MONEY</a>
            <a href="logout" type="button" class="btn ja-navbutton admin" role="button">LOGOUT</a>
            <?php
        }
        else
        {
