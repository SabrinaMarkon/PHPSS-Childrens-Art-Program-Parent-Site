...
class Product
{
    ...
    public function saveProduct($id) {
        ...
        Database::disconnect();
        return "<center><div class=\"alert alert-success\" style=\"width:75%;\"><strong>Product ID " . $id . " was Saved!</strong></div>";
    ...
    public function deleteProduct($id) {
        ...
        $q->execute(array($id));
        Database::disconnect();
        return "<center><div class=\"alert alert-success\" style=\"width:75%;\"><strong>Product ID " . $id . " was Deleted</strong></div>";
